object Q4_ListAccounts extends App {

  val account1= new BankAccount1("lahiru",01,10500.00)
  val account2= new BankAccount1("sanjana",02,5700.00)
  val account3= new BankAccount1("imesh",03,1890.00)
  val account4= new BankAccount1("chamidu",04,-3000.00)
